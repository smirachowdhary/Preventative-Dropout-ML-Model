This project is a Predictive Dropout Dashboard that allows users to upload student data in Excel or CSV format and analyze it to identify students who may be at risk of dropping out. The goal is to turn raw school data such as attendance, grades, and engagement into clear, actionable insights that can support early intervention.
